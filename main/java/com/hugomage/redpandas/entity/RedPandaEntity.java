...
import com.hugomage.redpandas.util.RegistryHandler;
...
public class RedPandaEntity extends AnimalEntity {
    ...
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(RedPandaEntity.class, DataSerializers.INT);
    ...
    public AgeableEntity getBreedOffspring(ServerWorld serverWorld, AgeableEntity ageableEntity) {
        RedPandaEntity orangutan = ModEntityTypes.REDPANDA.get().create(serverWorld);
    ...
    public static boolean canSpawn(EntityType<RedPandaEntity> type, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return (pos.getY() > 50);
    }
