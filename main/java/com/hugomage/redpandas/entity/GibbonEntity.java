...
public class GibbonEntity extends AnimalEntity {

    public static final Ingredient BREEDITEM = Ingredient.of(Items.BAMBOO);
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(GibbonEntity.class, DataSerializers.INT);

    public GibbonEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld serverWorld, AgeableEntity ageableEntity) {
        GibbonEntity orangutan = ModEntityTypes.GIBBON.get().create(serverWorld);
    ...
    public static boolean canSpawn(EntityType<GibbonEntity> type, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return (pos.getY() > 50);
    }
